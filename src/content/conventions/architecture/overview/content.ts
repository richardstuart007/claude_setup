...
export const content: ContentBlock[] = [
  {
    ...
    rows: [
      [
        "Project",
        "Scenario-specific to this author's setup: a private shared package, consumed by several of the author's own projects.",
      ],
      [
        "Elements",
        "Tables, components, and logging — this package owns its own database tables and a per-user server-side cache, a small set of shared primitive components and full UI panels, and a shared logging table.",
      ],
      [
        "Consumeables",
        "Full API details for every component prop, database function signature, and setup instruction are documented in node_modules/nextjs-shared/CONSUMING_PROJECTS.md, read at the start of every session in a consuming project.",
      ],
    ],
  },
  {
