...
export const content: ContentBlock[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["Primary Key", "xxx_xxxid", "usr_usrid", "id is the identifier, _id is also acceptable"],
      [
        "Column Name",
        "xxx_column_name",
        "usr_username",
        {
          list: [
            ...
            "A value read from or written to a given column is named after that column's own data-dictionary identifier wherever it appears in code.",
