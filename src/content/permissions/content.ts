...
export const content: ContentBlock[] = [
  ...
  {
    type: 'paragraph',
    text: "The exact tools flagged above are stack-specific. These are an npm-based install command, a SQL command-line client, and Windows-specific process commands. The general shape is the transferable part: installs, destructive version-control operations, destructive database access, and process-killing all require confirmation. The specific tool names are this setup's own stack.",
  },
]
